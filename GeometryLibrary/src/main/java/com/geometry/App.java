...
public class App {
    ...
    private static void calculateCircle() {
        ...
        addToHistory("Circle (r=" + Utils.formatDouble(radius) + "m)", 
    ...
    private static void calculateRectangle() {
        ...
        addToHistory("Rectangle (" + Utils.formatDouble(length) + "x" + Utils.formatDouble(width) + "m)", 
    ...
    private static void calculateTriangle() {
        ...
        } while (!Utils.isValidTriangle(side1, side2, side3));
        
        Shape triangle = new Triangle(side1, side2, side3);
        displayShapeResults("Triangle", side1 + "-" + side2 + "-" + side3 + "m", triangle);
        
        addToHistory("Triangle (" + Utils.formatDouble(side1) + "-" + Utils.formatDouble(side2) + "-" + Utils.formatDouble(side3) + "m)", 
    ...
    private static void handle3DShapes() {
        ...
        int choice = getIntInput("Choose a 3D shape (1-2): ", 1, 2);
    ...
    private static void calculateCube() {
        ...
        addToHistory("Cube (s=" + Utils.formatDouble(side) + "m)", 
    ...
    private static void compareAreas() {
        ...
        String result = Utils.compareAreas(shape1, shape2);
        System.out.println("\n📊 Comparison Result:");
        System.out.println("┌─────────────────────────────────────────────────┐");
        ...
        switch (choice) {
            ...
            case 3:
                ...
                do {
                    ...
                    if (!Utils.isValidTriangle(a, b, c)) {
    ...
    private static void convertToCm() {
        ...
        double areaInCm = Utils.convertMetersToCentimeters(areaInMeters);
    ...
    private static void checkTriangleValidity() {
        ...
        boolean isValid = Utils.isValidTriangle(a, b, c);
    ...
    private static void calculateAreaDifference() {
        ...
        double difference = Utils.areaDifference(shape1, shape2);
